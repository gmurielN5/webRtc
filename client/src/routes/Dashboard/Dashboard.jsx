  ...
  return (
    <div className="w-full h-full">
      <div className="flex flex-no-wrap">
        <div className="w-64 absolute sm:relative bg-neutral-900 shadow md:h-full flex-col justify-between hidden sm:flex">
          <div className="px-8">
            ...
            <ul className="mt-6">
              <li className="flex w-full justify-start gap-2 text-gray-300 cursor-pointer items-center mb-6">
                <FaHouse color="#a3a3a3" />
                <span>Dashboard</span>
              </li>
              <li className="flex w-full justify-start gap-2 text-gray-300 cursor-pointer items-center mb-6">
                <FaClock color="#a3a3a3" />
                <span>Meetings</span>
              </li>
              <li className="flex w-full justify-start gap-2 text-gray-300 cursor-pointer items-center mb-6">
                <FaUsers color="#a3a3a3" />
                <span>Contacts</span>
              </li>
              <li className="flex w-full justify-start gap-2 text-gray-300 cursor-pointer items-center mb-6">
                <FaCommentDots color="#a3a3a3" />
                <span>Messages</span>
              </li>
              <li className="flex w-full justify-start gap-2 text-gray-300 cursor-pointer items-center mb-6">
                <FaCalendar color="#a3a3a3" />
                <span>Calendar</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="container bg-neutral-50 mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
          <div className="row">
            <h1>Dashboard</h1>
